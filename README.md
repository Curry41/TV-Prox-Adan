...
This repository contains the MATLAB implementation of the algorithm proposed in the following published paper:

> **Qixiao Zheng, Tarmizi Adam**  
> *TV Prox-Adan: An Accelerated Algorithm for Robust Tensor Completion under Low Sampling Ratios*  
> **Digital Signal Processing**, Volume 183, 2026, Article 106381.  
> https://doi.org/10.1016/j.dsp.2026.106381
> 
The proposed method combines CP decomposition, total variation (TV) regularization, and the Adan optimizer to achieve robust and efficient tensor completion, especially under low sampling conditions.
